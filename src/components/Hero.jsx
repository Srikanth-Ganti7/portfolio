  ...
  return (
    ...
    {/* </section><section className="relative w-full h-screen mx-auto bg-hero-pattern"> */}
      ...
      >
        ...
        <div>
          {/* <h1 className = {`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#915eff]">Srikanth</span></h1> */}
          <h1 className = {`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#dba039]">Srikanth</span></h1>
